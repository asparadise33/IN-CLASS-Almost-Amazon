  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="card-text bold">${item.favorite ? `<span class="badge badge-info favorite-badge"><i class="bi bi-bookmark-heart-fill" aria-hidden="true"></i> Favorite</span> $${item.price}` : `$${item.price}`}</p>
        <hr>
